...
@TestForSubmission
public class TransposeListRecursiveTest extends H11_TestP {
    ...
    public void testGet(List<Object> invoked, int index, Object expectedElement, List<Object> expectedList) {
        TransposeListRecursive<?> test = new TransposeListRecursive<>(invoked.toArray());
    ...
    @ParameterizedTest
    @MethodSource("provideTestGet")
    public void testGet_move(List<Object> invoked, int index, Object expectedElement, List<Object> expectedList) {
        TransposeListRecursive<?> test = new TransposeListRecursive<>(invoked.toArray());
    ...
    public void testVA() throws NoSuchMethodException {
        List<CtLoop> loops = WhiteBoxTestUtilsP.getCtElements(
            (List) BasicPackageLink.of("h11")
                ...
                .toList(),
            CtLoop.class,
            BasicMethodLink.of(TransposeListRecursive.class.getDeclaredMethod("get", int.class)).getCtElement()
        ).toList();
