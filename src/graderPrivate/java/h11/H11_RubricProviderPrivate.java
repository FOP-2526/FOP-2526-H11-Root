        ...
        .addChildCriteria(
            ...
            criterion(
                "Die Methode get(int index) in MoveToFrontListIterative verschiebt das Element am angegebenen Index an den "
                    + "Anfang der Liste.",
                JUnitTestRef.ofMethod(() -> MoveToFrontListIterativeTest.class.getDeclaredMethod(
                    "testGet",
                    List.class,
                    int.class,
                    Object.class,
        ...
        .addChildCriteria(
            criterion(
                "Die Methode get(int index) in RandomRecursive vertauscht das Element am angegebenen Index korrekt mit dem Kopf"
                    + " der Liste.",
                JUnitTestRef.ofMethod(() -> RandomListRecursiveTest.class.getDeclaredMethod(
                    "testGet_first",
                    List.class,
                    int.class,
                    int.class,
    ...
    private static final Criterion H11_4_3 = Criterion.builder()
        ...
        .addChildCriteria(
            criterion(
                ...
                JUnitTestRef.ofMethod(() -> TransposeListIteratorTest.class.getDeclaredMethod(
                    "testGet",
                    List.class,
                    int.class,
                    Object.class,
