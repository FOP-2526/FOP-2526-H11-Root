...
@TestForSubmission
public class TransposeListIterativeTest extends H11_TestP {
    ...
    public void testGet(List<Object> invoked, int index, Object expectedElement, List<Object> expectedList) {
        TransposeListIterative<?> test = new TransposeListIterative<>(invoked.toArray());
    ...
    public void testVA() throws NoSuchMethodException {
        Assertions4.assertIsNotRecursively(
            BasicMethodLink.of(TransposeListIterative.class.getDeclaredMethod("get", int.class))
