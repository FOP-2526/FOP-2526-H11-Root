...
@TestForSubmission
public class RandomListIterativeTest extends H11_TestP {
    ...
    public void testGet_first(List<Object> invoked, int index, int randomIndex, Object expectedElement,
        ...
        RandomListIterative<Object> test = mock(RandomListIterative.class, CALLS_REAL_METHODS);
        RandomListIterative<Object> dataProvider = new RandomListIterative<>(invoked.toArray(), null);
    ...
    public void testVA() throws NoSuchMethodException {
        Assertions4.assertIsNotRecursively(
            BasicMethodLink.of(RandomListIterative.class.getDeclaredMethod("get", int.class))
